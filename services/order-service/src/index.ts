...
import { configureContainers, configureControllersAndServices, configureKafkaServices, configureInfrastructures, configureLifecycleServices } from 'application/ioc/bindings';
