...
import { configureContainers, configureControllersAndServices, configureMiddlewares, configureInfrastructures, configureKafkaServices } from 'application/ioc/bindings';
